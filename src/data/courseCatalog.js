...
export const COURSE_CATALOG = [
  {
    id: 'dca',
    name: 'DCA (Basic Computer Course) - NIELIT CCC Revision 4',
    shortTitle: 'DCA: CCC 90-Hour · MS Office + Digital India',
    level: 'Quick & Short Term · NIELIT CCC Aligned',
    courseHour: '90 Hours (30 Theory + 60 Practical)',
    certificationDuration: '3 Months (CCC Exam Ready)',
    enrollmentFees: 499,
    classFee: '₹10/class',
    urgent: '11 modules · 550+ MCQs · 3 mock tests · 15-day plan included',
    icon: '💻',
    visual: 'NIELIT CCC Digital Literacy',
    bgClass: 'from-blue-100 via-indigo-100 to-sky-100',
    content: [
      'NIELIT CCC Revision 4 (Oct 2023+) — 11 syllabus modules',
      'MS Word, Excel, PowerPoint + LibreOffice Writer, Calc, Impress',
      'Internet, email, UPI, e-governance (DigiLocker, UMANG), cyber security',
      '550+ practice MCQs, 3 full mock tests (100 MCQs each), 15-day study plan',
      'Practical lab packs — resume, spreadsheet, 5-slide presentation',
    ],
  },
  {
    id: 'cca',
